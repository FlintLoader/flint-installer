...
package net.flintloader.installer;

import net.flintloader.installer.client.ClientHandler;
import net.flintloader.installer.util.*;
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Loading Flint Installer: " + Main.class.getPackage().getImplementationVersion());
		...
		FlintService.setFixed(Reference.DEFAULT_META_SERVER, Reference.DEFAULT_MAVEN_SERVER);

		GAME_VERSION_META = new MetaHandler("v1/versions/game");
		LOADER_META = new MetaHandler("v1/versions/loader");
